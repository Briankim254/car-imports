            ...
            {data?.creditSales && (
              <div className="space-y-2">
                <div className="flex justify-between items-center bg-muted/50 p-2 rounded-md">
                  ...
                  <span className="text-sm font-bold">
                    {data?.creditSales?.amountPaidSoFar.toLocaleString(
                      "en-KE",
                      {
                        style: "currency",
                        currency: "KES",
                ...
                <div className="flex justify-between items-center bg-muted/50 p-2 rounded-md">
                  ...
                  <span className="text-sm font-bold">
                    {(data?.creditSales?.pendingBalance || 0).toLocaleString(
                      "en-KE",
                      {
                        style: "currency",
                        currency: "KES",
                ...
                <Badge
                  variant={
                    (data?.creditSales?.pendingBalance || 0) === 0
                      ? "secondary"
                      : "default"
                  }
                >
              ...
              {data?.costs ? (
                <>
                  ...
                  <div className="flex justify-between items-center bg-muted/50 p-2 rounded-md">
                    ...
                    <span className="text-sm font-bold">
                      {(data?.costs?.fuelAndDriver ?? 0).toLocaleString(
                        "en-KE",
                        {
                          style: "currency",
                          currency: "KES",
                  ...
                  <div className="flex justify-between items-center bg-muted/50 p-2 rounded-md">
                    ...
                    <span className="text-sm font-bold">
                      {(data?.costs?.clearingCost ?? 0).toLocaleString(
                        "en-KE",
                        {
                          style: "currency",
                          currency: "KES",
